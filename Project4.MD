...
![Alt text](<LAMP2/Apache status.png>)
...
![Alt text](<LAMP2/curl localhost.png>)
...
![Alt text](<LAMP2/mysql login .png>)
...
![Alt text](<LAMP2/php version.png>)
...
![Alt text](<LAMP2/Enable Projectlamp site.png>)

Disable the default site with a2dissite command

**`sudo a2dissite 000-default`**

![Alt text](<LAMP2/disable default site.png>)
...
![Alt text](<LAMP2/apache webpage.png>)
